...
const NICHOS: Record<string, NichoConfig> = {
  'bomberos': {
    ...
    heroTitulo:  'Convocatorias, sentencias e impugnaciones en oposiciones a bombero en España',
    heroDesc:    'Consulta publicaciones BOE, resoluciones judiciales y documentación de procesos selectivos estructurada desde fuentes públicas.',
