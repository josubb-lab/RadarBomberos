...
const NICHOS: Record<string, NichoConfig> = {
  'bomberos': {
    ...
    heroTitulo:  'Observatorio de irregularidades en oposiciones a bombero',
    heroDesc:    'Monitorizamos sentencias, impugnaciones y anomalías en oposiciones de bomberos en toda España.',
