...
const NICHOS: Record<string, NichoConfig> = {
  'bomberos': {
    ...
    seoTitle:    'Radar Bomberos · Buscador de señales en oposiciones a bombero',
    seoDesc:     'Busca precedentes de irregularidades, impugnaciones, sentencias y denuncias en oposiciones a bombero en España. Base de datos con más de 500 señales indexadas.',
    tagline:     'Transparencia · Oposiciones a Bombero · España',
  },
  'policia-local': {
